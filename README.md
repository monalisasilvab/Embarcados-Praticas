Esse codigo visa ao desenvolvimento e aprofundamento do proeto similar ao de RTOS onde trabalhamos com uma estufa q controlava o teto de exposição solar de uma colheita.
Neste projeto priorizamos o controle de um solenoide de 12v para controlar o fluxo da agua a ser passada para a planta,e a substituição do controle e recebiemnto de dados para o usuario que antes usava wifi e bluethoot local que dependia de curtas distancias,
